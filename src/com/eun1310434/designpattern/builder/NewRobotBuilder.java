...
public class NewRobotBuilder implements RobotBuilder {
	...
	public NewRobotBuilder() {this.robot = new Robot();}
	public void buildRobotHead() {robot.setRobotHead("NewRobot Head");}
	public void buildRobotTorso() {robot.setRobotTorso("NewRobot Torso");}
	public void buildRobotArms() {robot.setRobotArms("NewRobot Arms");}
	public void buildRobotLegs() {robot.setRobotLegs("NewRobot Legs");}
